...
main:
	...
	add.s $f12, $f6, $f2 		#adds 3 and 1
	add.s $f12, $f12, $f4 	#adds sum and 2
	
	#Transfers the value from the floating point reg to the integer reg
	...
	add.s $f12, $f6, $f4		#adds 2 and 3
	add.s $f12, $f12, $f2		#adds sum and 1
